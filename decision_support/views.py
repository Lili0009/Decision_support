...
def Dashboard(request):
    ...
    def water_alloc():
        ...
        config = {
            'displaylogo': False, 
            'displayModeBar': True,
            'modeBarButtonsToRemove': ['zoom', 'lasso','select2d','lasso2d']
            }
        ...
        final_html = custom_css + html_str
        return final_html
...
def Forecast(request):
    ...
    def rainfall_plot():
        ...
        last_known_date = original.index[-1]
        start_date = last_known_date + pd.Timedelta(days=-6)
        forecast_end_date = start_date + pd.Timedelta(days=297)
        forecast_dates = pd.date_range(start=start_date, end=forecast_end_date)
    ...
    def drawdown_plot():
        ...
        last_known_date = original.index[-1]
        start_date = last_known_date + pd.Timedelta(days=-6)
        forecast_end_date = start_date + pd.Timedelta(days=137)
        forecast_dates = pd.date_range(start=start_date, end=forecast_end_date)
